...
- Name: pipeline.spec.ts >> Pipeline Feature >> should display pipelines section in sidebar
- Location: e2e\pipeline.spec.ts:14:7
...
Call log:
  - waiting for locator('.pipelines-list, .sidebar') to be visible
