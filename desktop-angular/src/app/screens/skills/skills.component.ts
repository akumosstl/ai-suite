...
import { ApiService, Skill, SkillFile, Project, Template } from '../../services/api.service';
        ...
        <div class="right-panel">
          ...
          <div class="form-container">
            ...
            <mat-form-field class="full-width" appearance="outline">
              ...
              <textarea matInput [(ngModel)]="formSkill.instructions" rows="10" placeholder="Enter the instructions content"></textarea>
...
export class SkillsComponent implements OnInit {
  ...
  loadTemplates(): void {
    ...
    this.apiService.getTemplatesByType('skills').subscribe({
      next: (templates) => {
  ...
  onTemplateSelect(event: any): void {
    ...
    if (templateId) {
      ...
      if (template && template.template) {
        if (this.formSkill.instructions) {
          this.formSkill.instructions = this.formSkill.instructions + '\n\n' + template.template;
        } else {
          this.formSkill.instructions = template.template;
        }
      }
    }
  }
