...
@Component({
  selector: 'app-add-tool-file-dialog',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class AddToolFileDialogComponent {
  filePath = '';
  fileName = '';
  fileContent = '';

  constructor(
    public dialogRef: MatDialogRef<AddToolFileDialogComponent>
  ) {}
