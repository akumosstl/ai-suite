...
@Component({
  selector: 'app-add-plugin-file-dialog',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class AddPluginFileDialogComponent {
  filePath = '';
  fileName = '';
  fileContent = '';

  constructor(
    public dialogRef: MatDialogRef<AddPluginFileDialogComponent>
  ) {}
