...
@Component({
  ...
  template: `
    <div class="dialog-header">
      <mat-icon class="header-icon">{{ data.icon || 'edit' }}</mat-icon>
    ...
    <mat-dialog-actions class="dialog-actions">
      ...
      <button mat-raised-button (click)="onSave()" [disabled]="!inputValue" class="save-btn">
...
export class SimpleInputDialogComponent {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) public data: SimpleInputDialogData
  ) {
