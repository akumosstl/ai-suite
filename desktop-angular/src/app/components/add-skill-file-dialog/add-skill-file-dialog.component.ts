...
@Component({
  selector: 'app-add-skill-file-dialog',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class AddSkillFileDialogComponent {
  filePath = '';
  fileName = '';
  fileContent = '';

  constructor(
    public dialogRef: MatDialogRef<AddSkillFileDialogComponent>
  ) {}
