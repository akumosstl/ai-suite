...
export interface ViewProjectAgentsDialogData {
  projectId: number;
}

@Component({
  selector: 'app-view-project-agents-dialog',
  standalone: true,
  imports: [
    CommonModule,
    MatDialogModule,
    ...
    <mat-dialog-content class="dialog-content">
      <div class="table-container">
        ...
        <div *ngIf="!loading && agents.length === 0" class="empty-state">
          ...
          <span class="empty-hint">Click the + button to add agents to this project</span>
        </div>
...
export class ViewProjectAgentsDialogComponent {
  agents: Agent[] = [];
  loading = false;
  displayedColumns = ['name', 'category', 'level', 'actions'];

  constructor(
    public dialogRef: MatDialogRef<ViewProjectAgentsDialogComponent>,
    private apiService: ApiService,
    private cdr: ChangeDetectorRef,
    @Inject(MAT_DIALOG_DATA) public data: ViewProjectAgentsDialogData
  ) {
    this.loadAgents();
  }
